  ...
  for (const data of dataset) {
    ...
    test("Validate Quantities Update Functionality", async () => {
      test.info().annotations.push({
        type: "Description",
        description: `This test case involves validating the quantities update functionality for products in the shopping cart at once.`,
      });
      logTestCaseStart(
      ...
      logger.info(
        "All quantities are increased for products available in the cart"
      );
    ...
    test("Validate Remove Single Product From Minicart Functionality", async () => {
      test.info().annotations.push({
        type: "Description",
        description: `This test case involves validating the remove functionality from the minicart by removing the first item.`,
      });
      ...
      logger.info(
        "Congratulation! first product has been removed from the cart. The remove button is working fine."
      );
      logTestCaseEnd(
        "=>=>=> Validate Remove Single Product From Minicart Functionality. <=<=<="
      );
    ...
    test("Validate All Products Remove Functionality", async () => {
      ...
      expect(await shoppingCartPage.getEmptyCartTextAfterDeletion()).toBe(
        "You have no items in your shopping cart."
      );
      logger.info(
        "Congratulation! all products have been removed from the cart."
      );
      logTestCaseEnd(
        "=>=>=> Validate All Products Remove Functionality. <=<=<="
      );
